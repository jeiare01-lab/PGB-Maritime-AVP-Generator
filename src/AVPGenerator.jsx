...
const AVPGenerator = () => {
  ...
  const generateVideo = async () => {
    ...
    try {
      // Build Motion API payload from scenes
...
For each scene, include: sceneIndex, duration, textOverlay, animationStyle, transitionType.`
      ...
      // Simulate Motion API calls - in production, these would call actual Motion API
      const generateMotionVideo = async (variant, config) => {
        // Placeholder: In production, POST to Motion API with config
